...
from_string(url, output_path, options=None, toc=None, cover=None,configuration=None, cover_first=False)
from_file(url, output_path, options=None, toc=None, cover=None,configuration=None, cover_first=False)

url: 转换的文件地址
output_path： 输出的PDF地址
options： 设置生成pdf是的样式参数
...
options = {
    ...
    'margin-right': '0.5in', #页面右边距
    'margin-bottom': '1.1in', #页面下边距
    'margin-left': '0.5in', #页面左边距
    'encoding': "utf-8",
...
sources = r'E:/tools/wkhtmltopdf/bin/wkhtmltopdf.exe' #wkhtmltopdf安装本地绝对地址
